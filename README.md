...
For progressive generation with Continuum, patch the model before Continuum:
...
- **DiffAid / Untwisting RoPE:** keep these upstream of the progressive wrapper.
...
The project builds on public work including HiFlow, FrescoDiffusion, RALU, Self-Cascade Diffusion, CineScale, Just-in-Time, simple diffusion, Scaling Rectified Flow Transformers, FreeSwim, HRDiT, ResDiT, TokenFlow, FRESCO, MoVideo, Upscale-A-Video, LatentWarp, Spectrum, and SA-Solver.

See [CREDITS.md](CREDITS.md) for complete attribution, authors, papers, repositories, implementation provenance, and the boundary between those works and this H3-specific implementation.
