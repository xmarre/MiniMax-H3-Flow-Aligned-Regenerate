...
Production consolidation PRs: [Flow #73](https://github.com/xmarre/MiniMax-H3-Flow-Aligned-Regenerate/pull/73), [Sol-H3 #15](https://github.com/xmarre/ComfyUI-Sol-H3/pull/15), [VDN-H3-Plus #32](https://github.com/xmarre/ComfyUI-VDN-H3-Plus/pull/32), and [Continuum #34](https://github.com/xmarre/ComfyUI-H3-Continuum-Plus/pull/34). Flow #73 consolidates the independently hardware-validated Flow #70 source tree; the diagnostic branches remain unmerged.
