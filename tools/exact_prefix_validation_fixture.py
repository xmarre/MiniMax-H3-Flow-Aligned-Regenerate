...
def main() -> None:
    ...
    build_run.add_argument("--fixture", required=True)
    build_run.add_argument("--spec", required=True)
    build_run.add_argument("--output", required=True)
    ...
    if args.command == "build":
        ...
        receipt = build_run_receipt(_read(args.fixture), _read(args.spec))
        Path(args.output).write_text(
