try:
    ...
    from .h3_flow_regenerate.vae_decode import (
        NODE_CLASS_MAPPINGS as VAE_DECODE_NODE_CLASS_MAPPINGS,
    )
    from .h3_flow_regenerate.vae_decode import (
        NODE_DISPLAY_NAME_MAPPINGS as VAE_DECODE_NODE_DISPLAY_NAME_MAPPINGS,
    )
...
NODE_CLASS_MAPPINGS = {
    ...
    **VAE_DECODE_NODE_CLASS_MAPPINGS,
}
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    **VAE_DECODE_NODE_DISPLAY_NAME_MAPPINGS,
}
