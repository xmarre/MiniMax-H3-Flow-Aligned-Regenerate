...
def run_partitioned_progressive(
    ...
    suppressed_taps_before = int(
        binding.metrics.counters.get("partitioned_vdn_cross_grid_temporal_suppressed_taps", 0)
    )
    suppressed_rows_before = int(
        binding.metrics.counters.get("partitioned_vdn_cross_grid_temporal_suppressed_rows", 0)
    )
