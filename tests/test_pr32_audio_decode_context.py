...
def _decoded_sequence(*, right_gain: float = 1.0):
    ...
    primary = 0.35 * torch.sin(t * 0.0137)
    secondary = 0.17 * torch.sin(t * 0.0311 + 0.4)
    tertiary = 0.05 * torch.cos(t * 0.00073)
    timeline = (primary + secondary + tertiary).reshape(1, 1, -1)
